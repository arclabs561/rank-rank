...
- **File**: `rank-soft-python/examples/pytorch_autograd.py`
...
- **File**: `rank-soft-python/examples/jax_primitive.py`
...
- `rank-soft-python/examples/pytorch_autograd.py` - Fixed API calls
- `rank-soft-python/examples/jax_primitive.py` - Fixed API calls (partial)
