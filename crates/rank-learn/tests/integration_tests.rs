...
mod tests {
    ...
    fn test_ndcg_lambdarank_consistency() {
        ...
        let lambdas = trainer.compute_gradients(&imperfect_scores, &perfect_relevance, None).unwrap();
    ...
    fn test_lambdarank_gradient_properties() {
        ...
        let lambdas1 = trainer.compute_gradients(&scores1, &relevance1, None).unwrap();
        ...
        let lambdas2 = trainer.compute_gradients(&scores2, &relevance2, None).unwrap();
