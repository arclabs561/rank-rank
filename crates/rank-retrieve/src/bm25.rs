...
//!
//! **Limitations:**
//! - Not optimized for very large corpora (>1M documents)
//! - No block-max WAND optimization
//! - No skip lists for faster conjunction queries
//! - In-memory only (no persistence)
//!
//! # Backend Integration
//!
//! For large corpora, consider:
//! - **Tantivy**: Optimized BM25 with persistent storage, block-max WAND
//! - **Lucene/Elasticsearch**: Full-featured search engines with BM25
//!
//! **When to use optimized backends:**
//! - Corpus size > 1M documents
//! - Need persistent storage
//! - Need optimized query performance
//! - Need complex queries (boolean, phrase, field queries)
...
impl InvertedIndex {
    ...
    ///
    /// This is the main retrieval method. For trait-based usage, see `Retriever` implementation.
    ///
    /// # Performance
    ///
